...
private:
    ...
    SegmentTree<long double> matrixRateTree;                       // Holds the total rates of each spatial element
    BinarySearchTree<int64, long double> objectRateTree[POINTS];   // Holds the rates of each object in each spatial element
