    ...
    else if (!check_H)
    {
        ...
        { 
            if (attributes[0] == 1)
                ...
                energy_d[0] = 2.12;
            int maxH = round(11.569 * sqrt(attributes[0]));
            if (attributes[2] >= maxH)
                energy_b = 0;
            else
                energy_b = 0.18 * log(attributes[0] + 5.061);
            energy_d[2] = energy_b + emh;
            bind[0] = attfreq*exp(-energy_d[0]/KB/TEMPERATURE);
            bind[2] = attfreq*exp(-energy_d[2]/KB/TEMPERATURE);
            /*
            if (attributes[0]==1 && attributes[2]==1)
            { // SIA-H
                energy_b = 0.67;
                energy_d[2] = energy_b + emh;
                bind[0] = attfreq*exp(-energy_d[0]/KB/TEMPERATURE);
            ...
            else if (attributes[0]==1 && attributes[2]==2)
            { // SIA-H2
                energy_b = 0.40;
                energy_d[2] = energy_b + emh;
                bind[0] = attfreq*exp(-energy_d[0]/KB/TEMPERATURE);
            ...
            else if (attributes[0]==1 && attributes[2]==3)
            { // SIA-H3
                energy_b = 0.40;
                energy_d[2] = energy_b + emh;
                bind[0] = attfreq*exp(-energy_d[0]/KB/TEMPERATURE);
            ...
            else if (attributes[0]==1 && attributes[2]==4)
            { // SIA-H4
                energy_b = 0.05;
                energy_d[2] = energy_b + emh;
                bind[0] = attfreq*exp(-energy_d[0]/KB/TEMPERATURE);
            ...
            else if (attributes[0]==1 && attributes[2]==5)
            { // SIA-H5
                energy_b = 0.20;
                energy_d[2] = energy_b + emh;
                bind[0] = attfreq*exp(-energy_d[0]/KB/TEMPERATURE);
            ...
            else if (attributes[0]==2 && attributes[2]==1)
            { // SIA2-H
                energy_d[0] = 2.12;
                energy_b = 0.57;
                energy_d[2] = energy_b + emh;
            ...
            else if (attributes[0]==2 && attributes[2]==2)
            { // SIA2-H2
                energy_d[0] = 2.12;
                energy_b = 0.45;
                energy_d[2] = energy_b + emh;
            ...
            else if (attributes[0]==2 && attributes[2]==3)
            { // SIA2-H3
                energy_d[0] = 2.12;
                energy_b = 0.1;
                energy_d[2] = energy_b + emh;
            ...
            else if (attributes[0]==2 && attributes[2]==4)
            { // SIA2-H4
                energy_d[0] = 2.12;
                energy_b = 0.3;
                energy_d[2] = energy_b + emh;
