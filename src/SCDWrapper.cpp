...
void SCDWrapper::computeSinkDissRate(const int type, const int point)
{
    ...
    double ebVDislocation = 0.52, ebVGrainBndry = 1.53; //binding and migration energy of vacancy (https://www.sciencedirect.com/science/article/pii/S0168583X16305262?casa_token=b7rAhMVZrUoAAAAA:ROZdduwd16jNwvDPV9a43_7_6x-mR2UiwsFgnlrRBQesPhvw56c50_VtweFpqaQsXHbH4Zfp8cw)
