...
private:
    ...
    long double sinkRDislocationScrew;                 // rate of getting absorbed to screw dislocation sink
    long double sinkRDislocationEdge;                  // rate of getting absorbed to edge dislocation sink
...
public:
    ...
    long double computeDissReaction(const Object* const, unordered_map<int64, Object*>&, const int, const int) const; // compute net dissociation reaction rate (approximation to have net comb/diss rate to speed up sim)
    long double computeCombReaction(const Object* const, const Object* const, unordered_map<int64, Object*>&, const int) const;  // compute net comb rate (approximation to have net comb/diss rate to speed up sim)
