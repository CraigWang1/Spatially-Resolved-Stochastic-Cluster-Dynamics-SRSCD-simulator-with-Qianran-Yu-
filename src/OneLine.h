...
private:
    ...
    robin_hood::unordered_flat_map<int64, long double> secondR;  // second reaction rate
    
    // private functions
    void setOneLine(const Object* const, const int, robin_hood::unordered_flat_map<int64, Object*>&, robin_hood::unordered_flat_map<int64, Object*>&); // build one line
    void computeDiffReaction(const Object* const, const int, robin_hood::unordered_flat_map<int64, Object*>&);  // compute diffusion rate
    ...
    void computeRecombReaction(const Object* const, const int, robin_hood::unordered_flat_map<int64, Object*>&);
    double computeDimensionTerm(const double, const Object* const, const Object* const, const int) const;
    
public:
    OneLine(const Object* const, const int, robin_hood::unordered_flat_map<int64, Object*>&, robin_hood::unordered_flat_map<int64, Object*>&);
    ...
    void addReaction(const Object* const, const Object* const, robin_hood::unordered_flat_map<int64, Object*>&, const int); /* add one reaction when a new object is been created */
    void removeReaction(const int64); /* delete one reaction when an object is deleted */
    void updateReaction(const Object* const, const Object* const, robin_hood::unordered_flat_map<int64, Object*>&, const int);/* when the number of another object has changed, one rate in this line should be changed */
    void updateLine(const Object* const, const int, robin_hood::unordered_flat_map<int64, Object*>&, robin_hood::unordered_flat_map<int64, Object*>&); /* when number of this object has changed, rates in this line should be updated */
    void updateDiff(const Object* const, const int, robin_hood::unordered_flat_map<int64, Object*>&);
    ...
    long double computeDissReaction(const Object* const, robin_hood::unordered_flat_map<int64, Object*>&, const int, const int) const; // compute net dissociation reaction rate (approximation to have net comb/diss rate to speed up sim)
    long double computeCombReaction(const Object* const, const Object* const, robin_hood::unordered_flat_map<int64, Object*>&, const int) const;  // compute net comb rate (approximation to have net comb/diss rate to speed up sim)
