...
#define TEMPERATURE 1400.0  // [K] System temperature.
...
#define POINTS 101       // number of elements: one surface(Point 0), other bulk elements(NO.1,2,3,4,...,100) (front element includes surface element)
...
const double FRONTMOST_VOLUME = SURFACE_VOLUME; // the frontmost element also has a very thin surface layer
