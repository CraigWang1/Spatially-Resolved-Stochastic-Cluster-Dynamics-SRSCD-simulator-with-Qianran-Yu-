...
#define HEAT_OF_SOLUTION 0.19   // [eV] Heat of solution of H in W.

// Run parameters:
#define ION               // Irradiation type.
#define TOTAL_TIME 2500      // [s] Total simulated time.
#define TOTAL_DPA 2       // Total DPA to run for.
...
#define POINTS 100       // number of elements: one surface(Point 0), other bulk elements(NO.1,2,3,4,...,100) (front element includes surface element)
